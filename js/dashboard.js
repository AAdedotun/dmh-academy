    ...
    fetch('https://fakestoreapi.com/products')
        ...
        .then(courses => {
            ...
            courses.forEach(course => {
                ...
                card.className = 'dark:bg-gray-800 bg-gray-200 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition';
                card.innerHTML = `
...
fetch('https://jsonplaceholder.typicode.com/todos?_limit=30')
    ...
    .then(assignments => {
        ...
        assignments.forEach(item => {
            ...
            const textStyle = item.completed ? 'line-through text-gray-800 dark:text-gray-200' : 'text-gray-800 dark:text-gray-200';
            li.className = 'flex flex-col items-left p-4 rounded-lg shadow hover:shadow-lg transition dark:bg-gray-800 bg-gray-200 dark:text-gray-200 text-gray-800 m-4 ';
            li.innerHTML = `
